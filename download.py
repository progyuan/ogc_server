...
#--satellite --threads=20 --max-zoom=-2 --min-zoom=-2 --latitude=25.036389 --longitude=102.708611 --width=20.0 --height=20.0
#--satellite --threads=20 --max-zoom=14 --min-zoom=2 --latitude=25.036389 --longitude=102.708611 --latrange=2 --lngrange=2
