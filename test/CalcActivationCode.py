...
if __name__=="__main__":
    ...
    RequestCode='RW51D-V1588-WJGNH-9QQGV'
    if len(sys.argv)<2:
        print('Please enter RequestCode like RW51D-V1588-WJGNH-9QQGV')
        sys.exit(0)
    ...
    print( "The LicenseID is:CN123-12345-12345-12345")
    print( "The RequestCode is:%s" % RequestCode)
    print( "The Activation Code is:%s" % act30)
