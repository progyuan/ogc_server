...
$.webgis.form_fields.base_flds_6 = [ //超声波驱鸟装置
	...
	{display: "编号", id: "boxid", newline: true,  type: "select", editor:{data:[{value:'111',label:'111'},{value:'222',label:'222'},{value:'333',label:'333'}]}, group:'驱鸟装置', width:70, validate:{required:true}},
	{display: "组装图号", id: "assembly_graph", newline: true,  type: "text", group:'驱鸟装置', width:350}
];
